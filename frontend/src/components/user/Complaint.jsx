   ...
   return (<>
         <div className="text-white complaint-box">
            <form onSubmit={handleSubmit} className="compliant-form row bg-dark ">
               ...
               <div className="col-md-6 p-3">
                  <label htmlFor="status" className="form-label">Complaint Info</label>
                  <input placeholder='Complaint info' name="status" onChange={handleChange} value={userComplaint.status} type="text" className="form-control" id="pincode" required /></div>
               <label className=" p-3form-label text-light" htmlFor="comment">Description</label>
